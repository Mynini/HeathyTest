...
(function(window, undefined) {
                ...
                if (typeof num === "number") {
                    ...
                    for (i = 0; i < len; i++) {
                        ...
                        if (str) {
                            ...
                            Fre.each(str, function(i, item) {
                                item ? arr1.push(item) : "";
                                item.indexOf("width") !==-1? item="width:" + num +"px" :"";
                            ...
                            obj[i].setAttribute("style", "width:" + num + "px")
                        }
                    }
                }
            } else {
    ...
    Fre.fn.extend({
        ...
        //当attr存在时获取width,否则获取width
        width: function() {

            return Fre.width(this, arguments[0]);
        }
