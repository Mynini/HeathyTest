...
var slideAround = function(selector, params) {
 ...
 //箭头按钮加当前class
        ...
        if (defaults.method == "normal") {
            ...
            _this.slidePages[_this.index].style.transform="scale(1)";
            fadeOut()
    ...
    function fadeOut(){
        ...
        _this.slidePages[_this.prevIndex].style.transform="scale("+n+")";
        timer2=setTimeout(fadeOut,100);
    }
